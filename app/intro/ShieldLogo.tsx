...
export default function ShieldLogo({ size = 360, className }: ShieldLogoProps) {
  return (
    <svg
      viewBox="0 0 400 480"
      width={size}
    ...
    >
      <defs>
        ...
        <linearGradient id="quartRed" x1="0%" y1="0%" x2="0%" y2="100%">
      ...
      <g>
        <path
          d="M200 30 L370 80 Q370 280 200 450 Q30 280 30 80 Z"
          fill="url(#shieldFill)"
        ...
        <g clipPath="url(#shieldClip)">
          <rect x="30" y="30" width="170" height="200" fill="url(#quartRed)" />
          <rect x="200" y="230" width="170" height="220" fill="url(#quartRed)" />
          <rect x="0" y="0" width="400" height="480" fill="url(#innerGlow)" />
        </g>

        {/* Inner border */}
        <path
          d="M200 50 L355 92 Q355 275 200 430 Q45 275 45 92 Z"
          fill="none"
          stroke="url(#goldStroke)"
          strokeWidth="2.5"
          opacity="0.85"
        ...
        <g transform="translate(78, 110)" fill="url(#goldFill)">
        ...
        <g transform="translate(220, 100)" fill="url(#goldFill)">
        ...
        {/* Up arrow (lower-left) */}
        <g stroke="url(#goldFill)" strokeWidth="6" fill="none" strokeLinecap="round" strokeLinejoin="round">
        ...
        <g>
          <line x1="252" y1="298" x2="252" y2="370" stroke="url(#goldFill)" strokeWidth="2" />
          <rect x="244" y="312" width="16" height="40" fill="#7a1a1a" stroke="url(#goldFill)" strokeWidth="1.5" />
          <line x1="284" y1="285" x2="284" y2="375" stroke="url(#goldFill)" strokeWidth="2" />
          <rect x="276" y="300" width="16" height="55" fill="#7a1a1a" stroke="url(#goldFill)" strokeWidth="1.5" />
        </g>
      </g>
      ...
      <g transform="translate(0, 0)">
        <path
          d="M50,400 L60,392 L120,398 L200,392 L280,398 L340,392 L350,400 L335,418 L350,432 L290,438 L200,432 L110,438 L50,432 L65,418 Z"
          fill="#0B1F19"
          stroke="url(#goldStroke)"
          strokeWidth="3"
        />
